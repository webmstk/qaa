...
feature 'Add files to answer', %q{
  ...
  scenario 'user adds answer with attached files', js: true do
    ...
    within '.answers' do
      expect(page).to have_link 'spec_helper.rb', href: '/uploads/attachment/file/17/spec_helper.rb'
      expect(page).to have_link 'rails_helper.rb', href: '/uploads/attachment/file/18/rails_helper.rb'
    end
  end
